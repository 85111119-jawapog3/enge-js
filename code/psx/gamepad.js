mdlr('enge:psx:gamepad', m => {
  ...
  keyboard.set(38, { bits: 0x10, property: 'hi' }); /*  [^]  */
  keyboard.set(39, { bits: 0x20, property: 'hi' }); /*  [O]  */
  keyboard.set(40, { bits: 0x40, property: 'hi' }); /*  [X]  */
  keyboard.set(37, { bits: 0x80, property: 'hi' }); /*  [#]  */
  ...
  keyboard.set(87, { bits: 0x10, property: 'lo' }); /*  [u]  */
  keyboard.set(68, { bits: 0x20, property: 'lo' }); /*  [r]  */
  keyboard.set(83, { bits: 0x40, property: 'lo' }); /*  [d]  */
  keyboard.set(65, { bits: 0x80, property: 'lo' }); /*  [l]  */
